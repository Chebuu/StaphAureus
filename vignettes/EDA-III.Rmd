...
(
  ...
  ggplot(aes(x=isolate_num)) +
    ...
    labs(
      title='Mortality by COAG(+)/(-)',
      subtitle = '(S.aureus positive)'
    ) + theme_bw()
)
```
...
NOTE: Positive COAG(-) test results are labeled "Presumptive not *S.saprophyticus*".
